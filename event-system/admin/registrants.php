...
// FIXED: Stepping out TWO levels (../../) to correctly target the root folder from admin/events/
include("../../includes/db.php");

// Protect the route: ensure the user is logged in AND is an admin
if(!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin'){
    // FIXED: Corrected path depth to jump up out of two nested folders to reach auth context
...
if(isset($_POST['add_event'])){
    ...
    try {
        ...
        $insert = "INSERT INTO events (title, description, event_date, event_time, venue)
                   VALUES (:title, :description, :event_date, :event_time, :venue)";
        ...
        // FIXED: Successfully targets sibling listing file in the same 'events' subfolder
    ...
    <nav class="bg-[#1e293b] bg-gradient-to-r from-[#1e3a8a] to-[#0f172a] text-white shadow-lg border-b border-blue-900/40">
        <div class="max-w-4xl mx-auto px-6">
            <div class="flex items-center justify-between h-16">
                ...
                <div>
                    <a href="admin_add_event.php" class="bg-blue-600 text-white ... font-medium px-4 py-2 rounded-xl">
                             + Create Event
                        </a>
                    </a>
                </div>
